        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-x-1 gap-y-0">
          {amenitiesToDisplayOnPage.map((amenity) => {
            ...
            return (
              <div
                key={amenity.name}
                className="flex items-center text-sm md:text-sm lg:text-base text-center text-stormy-blue/80 font-normal tracking-tight leading-relaxed m-2 rounded-lg hover:bg-muted/50 transition-colors duration-200 ease-in-out"
              >
          ...
          <div className="mt-6 flex justify-center">
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full sm:w-auto text-sm md:text-sm lg:text-base 2k:text-base 4k:text-lg text-center text-stormy-blue/80 font-normal tracking-tight leading-relaxed m-2"
                >
                    ...
                    {amenities.map((amenity) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center text-sm md:text-base lg:text-sm 2k:text-base 4k:text-lg text-center text-stormy-blue/80 font-normal tracking-tight leading-relaxed m-1 rounded-lg hover:bg-muted/50 transition-colors duration-200 ease-in-out"
                        >
                          <AmenityIconComponent className="mr-3 h-5 w-5 text-accent flex-shrink-0" />
                          <span>{amenity.name}</span>
                        </div>
